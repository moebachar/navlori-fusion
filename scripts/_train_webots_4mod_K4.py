"""PLAN_12 — K=4 + drop `odom_raw` on the 4-modality stack.
...
OUT_DIR = ROOT / "runs" / "overnight" / "run2_iter_12"
...
def main():
    ...
    with open(OUT_DIR / "wifi_imu_camera_odom_K4.json", "w") as f:
        json.dump(out, f, indent=2)
    print(f"\nwrote {OUT_DIR / 'wifi_imu_camera_odom_K4.json'}", flush=True)
